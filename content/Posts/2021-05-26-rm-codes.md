...
description: Course notes and a Python implementation of two Reed-Muller decoding algorithms — Majority Logic Decoding and the Fast Hadamard Transform.
date: 2021-05-25
draft: false
tags:
  - coding_theory
...
I have coded up both these decoding algorithms. The implementation can be found [here](https://github.com/cathreya/cathreya.github.io/blob/master/static/notebooks/Reed-Muller-Codes.ipynb).
<object data="/static/pdf/ReedMuller.pdf" width="100%" height="1000" type='application/pdf'>
  <p><a href="/static/pdf/ReedMuller.pdf">Download PDF</a></p>
</object>
